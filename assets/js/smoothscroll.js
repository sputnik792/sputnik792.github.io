...
if(g.queue)f/=2;g.offset=both(g.offset);g.over=both(g.over);
...
return Math.max(html[scroll],body[scroll])-Math.min(html[d],body[d])};function both(a){return typeof a=='object'?a:{top:a,left:a}}})(jQuery);
